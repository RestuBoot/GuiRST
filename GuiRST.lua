...
-- GuiRST.lua - Final Universal + Auto Respawn + Fly
...
-- Tombol kecil untuk memunculkan GUI
...
-- Fly Toggle
local flying = false
makeButton("Terbang: Nonaktif", Color3.fromRGB(180,180,255), function(btn)
	flying = not flying
	btn.Text = flying and "Terbang: Aktif" or "Terbang: Nonaktif"
end)
